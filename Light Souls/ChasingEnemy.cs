...
namespace Light_Souls
{
    public sealed class ChasingEnemy
    {
        ...
        public void LoadAnimation(Animation anim) => _runAnimation = anim;
        ...
        public void Update(GameTime gameTime, IReadOnlyList<Platform> platforms, Player player)
        {
            ...
            if (_isStunned) { UpdateStunned(dt, platforms); return; }

            UpdateMovement(dt, player, platforms);
        }

        public void Stun(float duration = 1.5f) { _isStunned = true; _stunTimer = duration; Velocity.X = 0f; }
        ...
        private void UpdateMovement(float dt, Player player, IReadOnlyList<Platform> platforms)
        {
            ...
            if (Position.Y > _worldHeight + 300f) { Position.Y = _worldHeight + 300f; Velocity.Y = 0f; }
        }
